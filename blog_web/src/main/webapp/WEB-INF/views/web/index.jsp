    ...
    <main class="mdl-layout__content">
        <div class="demo-blog__posts mdl-grid">
            ...
            <%-- <div class="mdl-card coffee-pic mdl-cell mdl-cell--8-col">
                 ...
                 &lt;%&ndash;<div class="mdl-card__supporting-text meta mdl-color-text--grey-600">
            ...
            <c:if test="${blogs.size() > 0}">
                ...
                <c:forEach items="${blogs}" var="blog" varStatus="v">
                    <div class="mdl-card mdl-shadow--2dp <c:if test="${blog.bannerImgId==null}">amazing</c:if><c:if test="${blog.bannerImgId!=null}">on-the-road-again</c:if> mdl-cell mdl-cell--12-col">
                        ...
                        <div class="blog-content mdl-card__supporting-text mdl-color-text--grey-600">
                            <div id="editormd-view-${blog.id}" class="editormd-content">
                                <textarea style="display: none;"><c:out value="${blog.content}"
