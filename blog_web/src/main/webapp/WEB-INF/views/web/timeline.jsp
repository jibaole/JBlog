        ...
        <div class="demo-blog__posts mdl-grid">
            ...
            <div class="mdl-card something-else mdl-cell mdl-cell--8-col mdl-cell--4-col-desktop">
                ...
                <div class="mdl-card__media mdl-color--white mdl-color-text--grey-600">
                    <h2><a href="${ctx}/" class="a-underline">闲想录</a></h2>源于技术不止于技术
                </div>
                <div class="mdl-card__supporting-text meta meta--fill mdl-color-text--grey-600">
                    ...
                    <ul class="mdl-menu mdl-js-menu mdl-menu--bottom-right mdl-js-ripple-effect" for="menubtn">
                        <li class="mdl-menu__item">关于我</li>
                        <li class="mdl-menu__item">分类</li>
                        <li class="mdl-menu__item">标签</li>
                    </ul>
            ...
            <c:if test="${blogs.size() > 0}">
                ...
                <c:forEach items="${blogs}" var="blog" varStatus="v">
                    <div class="mdl-grid <c:if test="${blog.bannerImgId==null}">amazing</c:if><c:if test="${blog.bannerImgId!=null}">on-the-road-again</c:if> mdl-cell mdl-cell--12-col">
